"""
:mod:`create_disp_vtk` -- create VTK data file from nodout ASCII file generated by ls-dyna

.. module:: create_disp_vtk
   :synopsis: create VTK data file from nodout ASCII file
