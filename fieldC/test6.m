...
%
% xdc_convex_focused_array(no_elements,width,height,kerf,Rconvex,
...
dynaImat = sprintf('dyna-I-f%.2f-F%.1f-FD%.3f-a%.2f.mat', FIELD_PARAMS.Frequency, FIELD_PARAMS.Fnum, FIELD_PARAMS.focus(3), FIELD_PARAMS.alpha);
