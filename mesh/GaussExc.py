...
def main():
    ...
    load_nodeID_amp = read_process_nodes(sigma, center, amp, amp_cut,
                                         sym, nodefile)
    ...
    write_load_file(loadfilename, load_nodeID_amp, sigma, center, amp,
                    amp_cut, sym, header_comment)
...
def write_load_file(loadfilename, load_nodeID_amp, header_comment="$Generated by GaussExc.py\n"):
    """write load file
