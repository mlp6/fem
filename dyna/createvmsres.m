function []=createvmsres(zdispfile,node_asc,TimeStep,TerminationTime);
% function []=createvmsres(zdispfile);
...
for t=1:size(vms,3),
    temp(vms(:,1,1)) = vms(:,2,t);
    temp2 = temp(image_plane);
...
save res_sim_vms.mat arfidata lat axial t
